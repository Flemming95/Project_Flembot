...
│   └── docker/          # Docker setup
├── LIDAR_DETECTION.md   # LiDAR technical docs
├── LIDAR_TUTORIAL.md    # Step-by-step tutorial
└── REACTIVE_NAVIGATION.md # Navigation commands
```

## 📚 Documentation

- [LiDAR Detection](LIDAR_DETECTION.md) — Technical details on object detection
- [LiDAR Tutorial](LIDAR_TUTORIAL.md) — Getting started with LiDAR
- [Reactive Navigation](REACTIVE_NAVIGATION.md) — Command-based navigation
